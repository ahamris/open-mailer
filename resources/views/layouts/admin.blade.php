        ...
        <aside class="w-56 bg-white border-r border-gray-200 min-h-screen fixed left-0 top-0 flex flex-col z-10">
            ...
            <nav class="flex-1 py-2 px-3 overflow-y-auto">
                <a href="/admin" class="sidebar-item {{ request()->is('admin') && !request()->is('admin/*') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Overview
                </a>

                <div class="sidebar-section">Mail</div>
                <a href="/admin/mail" class="sidebar-item {{ request()->is('admin/mail') && !request()->is('admin/mail/compose') ? 'active' : '' }}">
                    ...
                    @if($unread > 0)<span class="ml-auto text-xs bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center">{{ $unread }}</span>@endif
                </a>
                ...
                <a href="/admin/workflows" class="sidebar-item {{ request()->is('admin/workflows*') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                    Workflows
                </a>

                <div class="sidebar-section">Settings</div>
                <a href="/admin/emails" class="sidebar-item {{ request()->is('admin/emails*') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                    Email Logs
                </a>
                <a href="/admin/domains" class="sidebar-item {{ request()->is('admin/domains*') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9"/></svg>
                    Domains
                </a>
                <a href="/admin/api-keys" class="sidebar-item {{ request()->is('admin/api-keys*') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
                    API Keys
                </a>
                ...
                <a href="/admin/docs/api" class="sidebar-item {{ request()->is('admin/docs/api') ? 'active' : '' }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
                    API Reference
                </a>
            </nav>
            ...
            <div class="p-4 border-t border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm font-medium text-gray-700 flex-1 truncate">{{ auth()->guard('admin')->user()?->name ?? 'Admin' }}</span>
        ...
        <main class="flex-1 ml-56">
            <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-[5]">
                <div>
                    ...
                    @hasSection('subtitle')<p class="text-sm text-gray-500 mt-0.5">@yield('subtitle')</p>@endif
                </div>
