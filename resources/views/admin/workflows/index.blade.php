...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="/admin/workflows/create" class="btn btn-primary btn-sm">+ Nieuwe workflow</a>
</div>
...
<div class="grid gap-4">
    ...
    <div class="bg-base-100 rounded-box shadow p-5">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="/admin/workflows/{{ $workflow->id }}/edit" class="btn btn-ghost btn-xs">Bewerk</a>
                <form method="POST" action="/admin/workflows/{{ $workflow->id }}" onsubmit="return confirm('Workflow verwijderen?')">
                    @csrf @method('DELETE')
    ...
    <div class="text-center py-12 text-base-content/40">
        <p class="mb-2">Nog geen workflows</p>
        <a href="/admin/workflows/create" class="btn btn-primary btn-sm">Maak je eerste workflow</a>
    </div>
    @endforelse
</div>
@endsection
