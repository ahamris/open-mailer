    ...
    <div class="stat-card">
        <div class="flex items-center justify-between">
            ...
            <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
            </div>
        </div>
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between">
            ...
            <div class="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172"/></svg>
            </div>
        </div>
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-semibold {{ $failedToday > 0 ? 'text-red-600' : 'text-gray-900' }} mt-1">{{ $failedToday }}</p>
            </div>
            <div class="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
            </div>
        </div>
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between">
            ...
            <div class="w-10 h-10 bg-purple-50 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3"/></svg>
            </div>
        </div>
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                <td class="px-5 py-3">
                    @php $colors = ['sent'=>'emerald','delivered'=>'emerald','received'=>'emerald','queued'=>'amber','sending'=>'amber','failed'=>'red','bounced'=>'red']; $c = $colors[$email->status] ?? 'gray'; @endphp
                ...
                <td class="px-5 py-3 text-sm text-gray-400">{{ $email->created_at->diffForHumans() }}</td>
            </tr>
            @empty
